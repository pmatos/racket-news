...
* Have you ever wished kickstarting a Racket app, library, gui app, command line app would be quicker? Well, meet [`racket-templates`](https://github.com/racket-templates).
