...
And that was just a brief synopsis of the main release points. Conference-wise, Jesse Alama organized RacketFest - not once, but twice. Both times in Berlin with the presence of Ryan Culpepper and Shriram Krishnamurti in the first event and Matthew Flatt in the second. Racket Summer School 2019 took place in July in Salt Lake City, had two tracks and counted with the presence of many from the Racket team. Right after was RacketCon 2019, where Aaron Turon opened with an amazing Keynote. There were many incredible talks but the highlight was Matthew Flatt's proposal to investigate a new surface syntax for a future Racket version - now codenamed Rhombus.
