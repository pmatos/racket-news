...
* `logic-programming` ([pkg](https://pkgs.racket-lang.org/package/logic-programming)/[src](https://github.com/silver-ag/logic-programming)) is a library that provides a prolog-like language that can be used within racket programs, by (quote silver-ag).
