...
Here we are with another issue of Racket. There's quite a bit of WebAssembly talk this issue but also crazy Discord bots and quite a few package releases. On the other hand, we are missing blog posts on Racket. We have a new experimental section on DrRacket Quickscripts, which you can use to enhance your favourite Racket editor. 
