...
* `mixfix` ([pkg](https://pkgs.racket-lang.org/package/mixfix)/[src](https://github.com/sorawee/mixfix/)) is library allows users to define and use mixfix operators in Racket, by Sorawee Porncharoenwase.
